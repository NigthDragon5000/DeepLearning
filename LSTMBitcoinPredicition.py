"""
Created on Wed Jun 19 13:56:17 2019
...
def normalize_windows(window_data):
    ...
    for window in window_data:
        normalised_window = window / 20000.00
...
print(float(preds)*20000.0)

preds_test=model.predict(X_test)
preds_test=preds_test * 20000

imagine=pd.DataFrame(preds_test,y_test*20000)
imagine=imagine.reset_index()
imagine.tail(10).plot()
